    ...
    <div class="container">
        <div class="ml-3 mt-5">
            ...
            <span class="text-muted">
                ...
                <a class="header-link" href="<?= URL_RAIZ . 'receitas/editar/' . $receita->getId() ?>">Editar receita</a>
            </span>
        </div>
        ...
        <div class="card m-3">
            ...
            <div class="card-body">
                <form action="<?= URL_RAIZ . 'receitas/' . $receita->getId() ?>" method="POST" class="margin-bottom">
                <input type="hidden" name="_metodo" value="PATCH">
                    <div class="form-row">
                        <div class="form-group col-md-12 <?= $this->getErroCss('titulo') ?>">
                            <label for="titulo">Título: *</label>
                            <input type="text" class="form-control" id="titulo" placeholder="Título" name="titulo" value="<?= $receita->getTitulo() ?>">
                            <?php $this->incluirVisao('util/formErro.php', ['campo' => 'titulo']) ?>
                        </div>
                        <div class="form-group col-md-12 mt-3 <?= $this->getErroCss('descricao') ?>">
                            <label for="descricao">Descrição: *</label>
                            <input type="text" class="form-control" id="descricao" placeholder="Descrição" name="descricao" value="<?= $receita->getDescricao() ?>">
                        ...
                        <div class="form-group col-md-12 mt-3 <?= $this->getErroCss('ingredientes') ?>">
                            ...
                            <textarea id="ingredientes" name="ingredientes" class="jqte-test"><?= $receita->getIngredientes() ?></textarea>
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col-12">
                          <button type="submit" class="btn btn-dark text-light">Editar</button>
                        </div>
                    </div>
                </form>
            </div>
